...
import { Dimensions, StyleSheet,ActivityIndicator, StatusBar, Text, View, Image, TouchableWithoutFeedback } from 'react-native';

import { Container, Drawer, Header, Content, Footer, FooterTab, Button, Icon, Badge } from 'native-base';
...
export default class EntrepreneurMain extends Component {
    constructor(props) {
        super(props);
        this.state = {
            screennumber: 3,
            loading:false,
            Icons: [require('../images/wallet.png'), require('../images/inbox.png'), require('../images/EDashA.png'), require('../images/markeet.png'), require('../images/profile.png')],
    ...
    Screen = () => {
        ...
        if (this.state.screennumber == 1) {
            ...
            return (<EHome openDrawer={() => this.openDrawer()} />)
        }
    ...
    changeicon = (index) => {
        let SelectedIcon = [require('../images/wallet.png'), require('../images/inbox.png'), require('../images/EDash.png'), require('../images/markeet.png'), require('../images/profile.png')]
        ...
        switch (index) {
            ...
            case 2:
                SelectedIcon[index] = require('../images/EDashA.png');
                Resetcolor[index] = 'white'
                this.setState({ Icons: SelectedIcon, tcolor: Resetcolor });
                break;
                    ...
                    <Footer style={{ backgroundColor: '#1F1724', borderTopColor: '#1F1724' }}>
                        <FooterTab style={{ backgroundColor: '#1F1724', height: 65 }}>
                            ...
                            <Button style={styles.btn} onPress={() => { this.SelectScreen(3), this.changeicon(2) }} vertical>
                                ...
                                <Text allowFontScaling={false} style={[styles.text, { color: this.state.tcolor[2] }]}>DASHBOARD</Text>
                            </Button>
                            ...
                            <Button style={styles.btn} onPress={() => { this.SelectScreen(4), this.changeicon(3) }} vertical>
                                ...
                                <Text allowFontScaling={false} style={[styles.text, { color: this.state.tcolor[3] }]}>MARKEET</Text>
                            </Button>
