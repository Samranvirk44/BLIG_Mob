...
export default class Active extends Component {
  ...
  componentDidMount() {
    console.log('in active:',this.props.data)
        ...
        <Content padder>
          {
            this.state.NewCompany.map((data, index) => (
              <TouchableWithoutFeedback key={index} onPress={()=>Actions.HCompanyProfile({Contract_Id: this.state.ContractedList[index].id, Active:true,Company_Id:this.state.ContractedList[index].company_id})}>
