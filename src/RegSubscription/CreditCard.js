    ...
    render() {
        return (
            <Container style={{ backgroundColor: '#110717' }}>
                <Header hasTabs androidStatusBarColor="black" iosBarStyle="light-content" style={{ alignItems: 'center', backgroundColor: '#110717' }}>
                ...
                <View style={styless.pv5}>
                    <TouchableWithoutFeedback onPress={() => this.Create_UserCardData()}>
                        <View style={styless.v6}>
                            <ImageBackground resizeMode="stretch" source={require('../images/buttoncolor.png')} style={[styless.btnimage, { width: '100%' }]}>
                                <Text onPress={() => this.Create_UserCardData()} allowFontScaling={false} style={styless.ptext3}>Proceed to confirm</Text>
                            </ImageBackground>
                        </View>
