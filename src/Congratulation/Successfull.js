        ...
        return (
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/breg9.png')} style={styles.imagebackground}>
                    ...
                    <Text allowFontScaling={false} style={styles.text2}>Your Payment is under review</Text>
                    <Text allowFontScaling={false} style={styles.text3}>we will inform you soon once approved</Text>
                    <TouchableWithoutFeedback onPress={() => Actions.pop()} >
                       <View style={styles.image} >
                        <Text style={{color:'white',fontSize:22}} onPress={() => Actions.pop()}>Proceed</Text>
                        </View>
...
const styles = StyleSheet.create({
    ...
    image: { backgroundColor:'#EC9705', width: 254, height: 56, alignSelf: 'center',justifyContent:'center',alignItems:'center', borderRadius: 30 },
