...
export default class ERegister7 extends Component {
    ...
    gotoReg7 = () => {
        if (this.state.filename.length == 0) {
            ...
            this.props.senddata(77, { Video: this.state.filename })
        ...
        return (
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/breg5.png')} style={styles.imagebackground}>
                    <Image source={this.props.LoanFinancing > 0 ? require('../images/reg7.png') : require('../images/reg8.png')} style={styles.image} />
